...
/>
            ...
            {/* Contact Form */}
            {showForm && (
              <div className="mt-10 bg-primary-foreground/10 backdrop-blur rounded-xl p-8 text-left animate-fade-up">
          ...
          <div className="bg-primary-foreground rounded-2xl p-8 shadow-lg h-fit">
